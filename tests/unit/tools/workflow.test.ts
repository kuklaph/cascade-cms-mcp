...
describe("api_read_workflow_settings tool", () => {
  test("happy path: calls client.readWorkflowSettings with identifier", async () => {
    ...
    const tool = findTool(tools, "api_read_workflow_settings");
  ...
  test("library throws: returns isError response", async () => {
    ...
    expect(firstText(result)).toContain("api_read_workflow_settings");
  });
});
...
describe("api_edit_workflow_settings tool", () => {
  test("happy path: calls client.editWorkflowSettings with settings", async () => {
    ...
    registerWorkflowTools(server as any, client);
    const tool = findTool(tools, "api_edit_workflow_settings");
  ...
  test("library throws: returns isError response", async () => {
    ...
    expect(result.isError).toBe(true);
    expect(firstText(result)).toContain("api_edit_workflow_settings");
  });
});
...
describe("api_read_workflow_information tool", () => {
  test("happy path: calls client.readWorkflowInformation with identifier", async () => {
    ...
    registerWorkflowTools(server as any, client);
    const tool = findTool(tools, "api_read_workflow_information");
  ...
  test("library throws: returns isError response", async () => {
    ...
    expect(result.isError).toBe(true);
    expect(firstText(result)).toContain("api_read_workflow_information");
  });
});
...
describe("api_perform_workflow_transition tool", () => {
  test("happy path: calls client.performWorkflowTransition with wrapped workflowTransitionInformation", async () => {
    ...
    registerWorkflowTools(server as any, client);
    const tool = findTool(tools, "api_perform_workflow_transition");
  ...
  test("library throws: returns isError response", async () => {
    ...
    expect(result.isError).toBe(true);
    expect(firstText(result)).toContain("api_perform_workflow_transition");
  });
});
