 ...
 *
 *   api_list_sites — list sites accessible to the API credentials
 *   api_site_copy  — duplicate an entire site under a new name
 *
...
Examples:
  ...
  - Don't use when: You want to copy a single asset — use api_copy.
