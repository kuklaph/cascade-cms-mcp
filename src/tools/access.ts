 ...
 *
 *   api_read_access_rights — fetch ACL for an asset
 *   api_edit_access_rights — modify ACL (optionally cascade to children)
 *
...
Examples:
  ...
  - Don't use when: You want to change permissions — use api_edit_access_rights.
  - Don't use when: You want workflow settings — use api_read_workflow_settings.
...
Examples:
  ...
  - Don't use when: You only want to read — use api_read_access_rights.
  - Don't use when: You want to change workflow policy — use api_edit_workflow_settings.
