 ...
 *
 *   api_publish_unpublish — publish or unpublish an asset to its destinations
 *
...
Examples:
  ...
  - Don't use when: You want to delete entirely — use api_remove (which can unpublish too).
